 ...
 */
public class gradespersem extends javax.swing.JPanel {
  ...
  private void dt() {
        ...
        try {
            ...
            stmt = con.prepareStatement("SELECT Username FROM `login` WHERE `Date` =? ORDER BY `Time` DESC LIMIT 1");
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            Date d = new Date();
            ...
            if (rs.next()) {
                ...
                control.openDocument(username + "-viewgrades2.pdf");
