 ...
 */
public class admingenerategrades extends javax.swing.JPanel {

    public admingenerategrades() {
        initComponents();
  ...
  public void searchStudentinfo() {
        ...
        try {
            ...
            Rs = St.executeQuery("SELECT `final_grade` as 'Final Grade', `course_code` as 'Course Code', `course_title` as 'Course Title' , `unit` as Unit, `lec` as Lec, `lab` as Lab, `prerequisite` as 'Pre-Requisite', IF(`corequisite` = 'null', ' ', `corequisite`) as 'Co-Requisite', Semester,Years FROM `studentfinalgrades`  WHERE studentfinalgrades.SR_Code='"+srcodes.getText()+"'");
  ...
  public void tableGwa() {
        ...
        try {
            ...
            St = Con.createStatement();
            Rs = St.executeQuery("SELECT Years as 'Year Level', Semester, FORMAT((SUM(SUBSTRING_INDEX(final_grade, ',', -1) * unit))/SUM(unit), 5)   AS `GWA` FROM studentfinalgrades WHERE SR_Code='"+srcodes.getText()+"' GROUP BY Years, Semester ORDER BY `studentfinalgrades`.`ID` ASC");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(srcodes, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
...
prntperSem();  System.out.println("npindot");      // TODO add your handling code here:
...
// execute SQL query
    ...
    String sqls = "SELECT * FROM `student` where SR_Code='"+srcodes.getText()+"'";
            ResultSet rs = null;
            try {
                rs = St.executeQuery(sqls);
                System.out.println("RS"+sqls);
            } catch (SQLException ex) {
                Logger.getLogger(admingenerategrades.class.getName()).log(Level.SEVERE, null, ex);
            }
