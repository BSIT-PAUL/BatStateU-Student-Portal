...
Connection Con = null;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        ...
        int result = JOptionPane.showConfirmDialog(null, "Are you sure you want to Delete " + model.getValueAt(Myindex, 1).toString(), "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    public void deleteaccount(){
      DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        int Myindex = jTable1.getSelectedRow();
         ...
         JOptionPane.showInputDialog("Are you sure you want to Delete " + model.getValueAt(Myindex, 1).toString());

            try {
                Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/studentportal", "root", "");

                String Query = "Delete from studentportal.users where user_id='" + model.getValueAt(Myindex, 0).toString() + "'";
